...
사진, 챗봇, 키워드, 설문 기반의 다양한 추천 경험을 제공하며, 추천 결과를 단순히 확인하는 데서 끝내지 않고 저장하거나 공유할 수 있는 사용자 흐름까지 제공합니다.
...
| 프로젝트 목적 | 사용자가 자신에게 맞는 향기를 쉽게 찾을 수 있도록 돕는 서비스                                 |
| 팀 구성       | FE 3명, BE 4명                                                                                |
| 담당 포지션   | Frontend                                                                                      |
| 배포          | Vercel                                                                                        |
...
- 담당 페이지 반응형 UI 구현
- 인증 상태에 따른 접근 제어 처리
- 공유 URL 및 OG 관련 문제 수정
- 마이페이지 캐시 갱신 관련 문제 해결
...
저장 완료 후 관련 쿼리를 무효화하거나 재조회하도록 TanStack Query의 캐시 갱신 흐름을 정리해, 사용자가 저장한 추천 결과를 마이페이지에서 즉시 확인할 수 있도록 수정했습니다.
